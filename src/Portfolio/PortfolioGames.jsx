import {
  ...
  <ul className="uk-subnav uk-subnav-pill uk-animation-slide-right">
         ...
         <li uk-filter-control="[data-tags*='Illus']"><Link to="/portfolio/illustration">Illustration</Link></li>
         <li className="uk-active" uk-filter-control="[data-tags*='Games']"><Link to="/portfolio/games">Games</Link></li>
